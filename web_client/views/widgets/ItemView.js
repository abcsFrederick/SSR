...
import ItemPageTemplate from '../../templates/widgets/itemPage.pug';
...
*/
            this.model.getRootPath((resp) => {
                ...
                let itemObj={'object':{'name':this.model.get('name'),'parentId':this.model.get('folderId'),'_id':this.model.get('_id')},'type':'folder'}
                resp.push(itemObj)
