...
class Folder(AccessControlledModel):
    ...
    def initialize(self):
        ...
        self.exposeFields(level=AccessType.READ, fields=(
            ...
            'baseParentType', 'baseParentId', 'segmentation'))
    ...
    def createFolder(self, parent, name, description='', parentType='folder',
                     public=None, creator=None, allowRename=False, reuseExisting=False, inheritPolicy=False):
        """
        ...
        if parentType in ('folder', 'collection') and inheritPolicy:
