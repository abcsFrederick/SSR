...
var workflow = View.extend({
	...
	//           this.$('.g-analyses-nav-container').html(workflowNavTemplate({
	...
	_collaspeSideBar(e){
		...
		if($(e.target).children().hasClass('collapsein')){
			this.$('.g-analyses-nav-container').css('left','calc(-40vw + 20px)');
			this.$('.g-analyses-nav-container').css('marginLeft','0vw');
			this.$('.analyses-body').css('width','calc(100vw - 20px)');
			this.$('.analyses-body').css('marginLeft','0');
		}else{
			this.$('.g-analyses-nav-container').css('left','0vw');
			this.$('.g-analyses-nav-container').css('marginLeft','0vw');
			this.$('.analyses-body').css('width','60vw');
			this.$('.analyses-body').css('marginLeft','0');
		}
