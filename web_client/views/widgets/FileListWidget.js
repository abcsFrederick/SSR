...
import FileListTemplate from '../../templates/widgets/fileList.pug';
...
var FileListWidget = View.extend({
    events: {
        ...
        'click a.g-file-list-link':'selectSEG'
    },
    ...
    selectSEG(e){
        $('.SEG_selected').html(e.currentTarget.innerText);
        events.trigger('s:setSEG',e.currentTarget.id);
    }
});
